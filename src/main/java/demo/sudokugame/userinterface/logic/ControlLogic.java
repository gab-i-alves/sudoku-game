package demo.sudokugame.userinterface.logic;
 ...
 * necessary. Break these things up when building applications with more screens/features.
 */
public class ControlLogic implements IUserInterfaceContract.EventListener {

    private IStorage storage;
    // Remember, this could be the real UserInterfaceImpl, or it could be a test class which implements the same interface
