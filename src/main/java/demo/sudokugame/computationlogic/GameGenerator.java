...
class GameGenerator {
     ...
     * and randomly assign a certain number of tiles to be equal to 0. It appears that there is no straight forward
     * way to check if a puzzle is still solvable after removing the tiles, beyond using another algorithm to attempt
     ...
     * 4a. Solveable -> return the new Array
     * 4b. Return to step 1
     * @param solvedGame
     * @return
     */
