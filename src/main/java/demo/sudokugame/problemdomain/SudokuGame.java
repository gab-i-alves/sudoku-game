...
/**
 * Serializable is imported to indicate that instances of this class can be serialized, meaning they
 * can be converted into a byte stream and then stored in a file or sent over the network.
 * <p>
 *  A program contains representations of real world objects (money, user, game). These things contain
 *  real world information (although they may also contain useless/stub/test information), and are
 *  necessary for a program which does anything practical.
 * <p>
